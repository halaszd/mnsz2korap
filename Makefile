...
mnsz2korapxml:
	cd scripts; python3 mnsz2korapxml.py /store/corpora/mnsz2_20180606-source/sources/* -m /store/share/projects/mnsz2/xml_clean/\**/\*.xml  -d /store/share/resources/corpora/MNSZ_korap -c